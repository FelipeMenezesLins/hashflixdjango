...
DATABASE_URL = os.getenv("postgresql://postgres:LGUXglOCYPthQILXtiONuWnVnIfVsvym@postgres.railway.internal:5432/railway")#ele só funciona se vc tiver rodando o cod lá no servidor!
